    ...
    <div class="split-container">
        ...
        <div class="left-panel">
            ...
            <div class="left-content">
                <p class="welcome-label">Setel Ulang Kata Sandi</p>
        ...
        <div class="right-panel">
            <div class="form-container">
                ...
                <div class="logo-section stagger-1">
                    ...
                    <div class="form-caption">Kata Sandi Baru</div>
                </div>

                <div class="form-instructions stagger-2">
                    Masukkan kata sandi baru untuk akun <strong>{{ $email }}</strong>. Kata sandi minimal terdiri dari 8 karakter.
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" id="resetForm" data-turbo="false">
                    @csrf
                    ...
                    <div class="form-group stagger-4">
                        ...
                        <div class="input-wrapper">
                            <input type="password" name="password_confirmation" id="password_confirmation" required
                                ...
                                class="form-input" style="padding-right: 2.25rem;">
                            <button type="button" id="toggleConfirmPassword" class="toggle-password" tabindex="-1">
                                <svg id="eyeConfirmIcon" xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                            </button>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" id="submitBtn" class="btn-submit stagger-5">
                ...
                <div class="form-footer-links stagger-5">
                    <span class="link-item">
                        Batal? <a href="{{ route('login') }}" data-turbo="false">Kembali ke Login</a>
                    </span>
                </div>
    ...
    <script>
        {
            ...
            if (toggleConfirmPassword && confirmInput && eyeConfirmIcon) {
