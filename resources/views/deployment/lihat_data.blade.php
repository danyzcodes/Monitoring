        ...
        <div class="bg-white rounded-2xl shadow-sm border p-5"
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-between items-center mb-4">
                ...
                <div class="flex justify-end">
                    <a href="{{ route('deployment.lihat-data.export', request()->query()) }}" data-turbo="false"
                ...
                <form id="filterForm" method="GET" action="{{ route('deployment.lihat-data') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        <div class="flex items-end col-span-1 gap-2">
                            <a href="{{ route('deployment.lihat-data') }}" class="w-1/3 bg-slate-100 text-slate-600 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-semibold hover:bg-slate-200 transition shadow-sm text-center flex items-center justify-center" title="Reset Filter">
            ...
            function tagSearch() {
                return {
                    ...
                    doSearch() {
                        ...
                        const url = `{{ route('deployment.lihat-data') }}?${urlParams.toString()}`;
